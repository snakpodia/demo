...
Scenario: Verify that selecting a Role and Country for Accountant in Brazil shows an accurate salary graph
...
Scenario: Verify that selecting a Role and Country for QA Engineer in Canada an accurate salary graph
...
Scenario: Verify that selecting a Role and Country for Software Engineer in Japan an accurate salary graph
